...
$PAGE->set_url($CFG->wwwroot . '/local/learningcompanions/groups/list.php');
$defaultlayout = 'base';
...
$PAGE->set_title(get_string('listgroups', 'local_learningcompanions'));
...
echo $OUTPUT->header();
echo $OUTPUT->render_from_template('local_learningcompanions/group_list', array(
    'groups' => $groups,
    'cfg' => $CFG
));
echo $OUTPUT->footer();